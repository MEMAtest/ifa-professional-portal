...
// ENHANCED VERSION: Adds beautiful transparent user menu dropdown
'use client'
...
export const Header: React.FC = () => {
  ...
  // Generate breadcrumbs based on current path (unchanged)
  ...
  return (
    <header className="fixed top-0 left-0 right-0 h-16 bg-white border-b border-gray-200 z-50">
      <div className="flex items-center justify-between h-full px-6">
        {/* LEFT: Logo + Breadcrumbs (unchanged) */}
        <div className="flex items-center gap-6 flex-1 min-w-0">
          <div className="flex-shrink-0">
            <h1 className="text-xl font-bold text-blue-600">IFA Platform Pro</h1>
          </div>
        ...
        <div className="flex items-center space-x-4 flex-shrink-0">
          {/* Quick Dashboard Button (unchanged) */}
          {pathname !== '/dashboard' && (
            <Link
              href="/dashboard"
