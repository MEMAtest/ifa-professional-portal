...
export async function GET(
  ...
  try {
    ...
    if (firmError || !firm) {
      console.error('[Admin Firm] Error fetching firm:', firmError)
    ...
    if (profileError) {
      console.error('[Admin Firm] Error fetching users:', profileError)
    ...
    console.error('[Admin Firm] Unexpected error:', error)
