...
// Persona Assessment Questionnaire - Determines Client Persona
// ================================================================
...
export default function PersonaAssessmentPage() {
  ...
  if (isComplete && calculatedPersona) {
    return (
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex justify-center space-x-4">
          ...
          <Button onClick={() => alert('Persona saved to client profile!')}>
