...
interface SuitabilityFieldProps {
  ...
  isFromDocuments?: boolean // Indicates field was auto-populated from analysed documents
}
...
export const SuitabilityField = memo(function SuitabilityField({
  ...
  const showPulledIndicator = isPulledFromProfile && value && !isFromDocuments
  const showDocumentsIndicator = isFromDocuments && value
  const datalistId =
