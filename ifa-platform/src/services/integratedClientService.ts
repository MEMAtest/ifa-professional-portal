    ...
    try {
      ...
      const clientData = {
        ...
        financial_profile: {
          ...
          propertyValue: formData.financialProfile?.propertyValue || 0,
          mortgageOutstanding: formData.financialProfile?.mortgageOutstanding || 0,
          otherLiabilities: formData.financialProfile?.otherLiabilities || 0,
          emergencyFund: formData.financialProfile?.emergencyFund || 0,
          disposableIncome: formData.financialProfile?.disposableIncome || 0,
          totalAssets: formData.financialProfile?.totalAssets || 0,
          investmentAmount: formData.financialProfile?.investmentAmount || 0,
  ...
  private transformToClientProfile(dbClient: any): ExtendedClientProfile {
    ...
    return {
      ...
      financialProfile: {
        ...
        propertyValue: financialProfile.propertyValue || financialProfile.property_value || 0,
        mortgageOutstanding: financialProfile.mortgageOutstanding || financialProfile.mortgage_outstanding || 0,
        otherLiabilities: financialProfile.otherLiabilities || financialProfile.other_liabilities || 0,
        emergencyFund: financialProfile.emergencyFund || financialProfile.emergency_fund || 0,
        disposableIncome: financialProfile.disposableIncome || financialProfile.disposable_income || 0,
        totalAssets: financialProfile.totalAssets || financialProfile.total_assets || 0,
        investmentAmount: financialProfile.investmentAmount || financialProfile.investment_amount || 0,
