...
export type Database = {
  ...
  public: {
      ...
      document_templates: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["category_id"]
            isOneToOne: false
            referencedRelation: "document_category_analytics"
    ...
    Views: {
      ...
      document_category_analytics: {
        Row: {
          ...
          signature_completion_rate: number | null
          trend: string | null
        }
        Relationships: []
      }
      document_dashboard_stats: {
        Row: {
          activity_last_24h: number | null
          archived_count: number | null
          avg_time_to_sign_hours: number | null
          completed_signatures: number | null
          compliance_approved: number | null
          compliance_pending: number | null
          created_this_month: number | null
          created_this_week: number | null
          expired_signatures: number | null
          firm_id: string | null
          pending_signatures: number | null
          stats_generated_at: string | null
          system_generated_count: number | null
          total_documents: number | null
    ...
    Functions: {
      ...
      cleanup_expired_assessment_drafts: {
        Args: Record<PropertyKey, never>
        Returns: number
      }
      cleanup_old_monte_carlo_results: {
        Args: Record<PropertyKey, never>
        Returns: undefined
      }
      cleanup_old_stress_test_results: {
        Args: Record<PropertyKey, never>
        Returns: number
      }
      ...
      update_overdue_reviews: {
        Args: Record<PropertyKey, never>
        Returns: undefined
      }
      update_scenario_usage_stats: {
        Args: Record<PropertyKey, never>
        Returns: undefined
      }
    }
