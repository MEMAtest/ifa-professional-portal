...
-- Combines: 20260203_security_hardening + 20260204_drop_legacy_shares
-- ================================================================

-- ================================================================
-- MIGRATION 1: Security Hardening (20260203)
-- ================================================================
...
-- Assessment shares (firm scoping for internal access)
...
-- ================================================================
-- MIGRATION 2: Drop Legacy Shares Policies (20260204)
-- ================================================================
...
-- ================================================================
-- Record migrations in Supabase history so CLI stays in sync
-- ================================================================
INSERT INTO supabase_migrations.schema_migrations (version, statements_hash)
VALUES ('20260203', 'manual_security_hardening')
ON CONFLICT (version) DO NOTHING;

INSERT INTO supabase_migrations.schema_migrations (version, statements_hash)
VALUES ('20260204', 'manual_drop_legacy_shares')
ON CONFLICT (version) DO NOTHING;

-- ================================================================
-- VERIFICATION: Run after the above completes
-- ================================================================
-- Check for any remaining USING(true) policies:
