...
AND table_name IN ('client_services', 'communications', 'consumer_duty_assessments', 'vulnerability_assessments')
ORDER BY table_name;

-- 2. If no results above, the tables don't exist. Run this to create them:
-- ================================================================
